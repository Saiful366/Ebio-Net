...
st.set_page_config(
    page_title="PlantVision AI | Professional Edition",
    page_icon="🌿",
    layout="wide",
...
st.markdown("""
    <div class="nav-header">
        <div class="nav-logo">🌿 PLANT<span>VISION</span> AI</div>
        <div class="nav-status">● SYSTEM READY | INDUSTRIAL ENGINE</div>
    </div>
    <div class="hero-container">
        <h1 class="hero-title">🌿 PlantVision AI</h1>
        <div class="step-grid">
...
st.markdown('<div class="footer"><p>© 2026 PlantVision Precision Systems • v3.6 Industrial Core</p></div>', unsafe_allow_html=True)
